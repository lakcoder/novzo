...
if(isset($_POST['login'])){
  ...
  if($email=="" || $password==""){
      $msgv =  "Please fill all the details";
  }
  else{
  ...
  if($num>0){
    ...
    if(password_verify($password,$data['Password'])){
        if($data['ConfirmEmail']==0){
            $msgv = "Please verify your email. Check your inbox.";
            $msgv2 = "Our email may go in spam. Mark it 'Not Spam' to click on the verification link.<br> We regret any inconvience." ;
        } else {
        ...
        $msgv = "Please recheck your inputs";
    }
  }else{
    $msgv = "Your email isn't registered with us.";
  }
  }
 ?>
<?php $pageTitle="Validate " ?>
<html>
<head>
    ...
    <div class="box">
      <div class="container">
          ...
          <section class="wrapper banner-content" style="padding-top:20px;">
            <p style="color:black"><?php echo $msgv ?></p>
            <h3 style="color:black"><?php echo $msgv2 ?></h3>
          </section>
        </div>
      </div>
    </div>

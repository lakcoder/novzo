...
<head>
  ...
  <meta property="twitter:image" content="https://i.imgur.com/LmBW675.jpg">
    ...
    <div class="cd-user-modal-container"> <!-- this is the container wrapper -->
      ...
      <div id="cd-signup"> <!-- sign up form -->
        <form class="cd-form" action="registration.php" method="POST">
          ...
          <p class="fieldset">
            <label for="accept-terms">By proceding through the button below, you agree to the <a href="customer/Novzo_policy.pdf">Terms and Conditions</a></label>
          </p>
    ...
    <div class="box">
      <div class="container">
          ...
          <section class="wrapper banner-content" style="padding-top:20px;">
            ...
            <h3 style="color:black"><?php echo $msg2 ?></h3>
